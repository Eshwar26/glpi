"""
GLPI Agent Task Inventory MacOS Hostname Module

This module collects hostname information on macOS systems.
"""
...
class Hostname:
    """MacOS Hostname inventory module."""
    ...
    def do_inventory(self, **params):
        """
        Perform the hostname inventory and add results to inventory.
        ...
        hostname = self._get_hostname(logger=logger)
        
        if hostname:
            inventory.set_hardware({'NAME': hostname})
    
    def _get_hostname(self, **params):
        """
        Get the hostname from system_profiler.
